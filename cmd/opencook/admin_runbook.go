	...
	runbooks := []adminRunbook{
		...
		},
		{
			...
			Unsupported: []adminRunbookUnsupportedEntry{
				...
				{Workflow: "omnibus maintenance-mode wrappers", Reason: "OpenCook has its own maintenance gate; chef-server-ctl-specific wrapper behavior remains outside the product surface"},
