...
func (c *command) printStartupBanner(w io.Writer) {
...
║     ╚═════╝ ╚═╝     ╚══════╝╚═╝  ╚═══╝ ╚═════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝     ║
║                                                                              ║
║                  Open Source Infrastructure, Served Hot                      ║
║                                                                              ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
║                         Initializing OpenCook Server                         ║
║                                                                              ║
║                              (  )   (   )  )                                 ║
║                               ) (   )  (  (                                  ║
║                               ( )  (    ) )                                  ║
...
║                                  ||    ||                                    ║
║                                                                              ║
║              [ whisking APIs ]  [ simmering indexes ]  [ plating nodes ]     ║
║                                                                              ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
║   License : Apache 2.0                                                       ║
║   Creator : Jaysen Nielsen                                                   ║
║                                                                              ║
║   Repository-ready. Community-seasoned. Chef-compatible-ish.                 ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
`
...
func runServer(ctx context.Context, cfg config.Config, logger *log.Logger, build version.Info) error {
	...
	fmt.Fprint(logger.Writer(), application.StartupSummary())
