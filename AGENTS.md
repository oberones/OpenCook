...
- the first cookbook compatibility slice:
  ...
  - multi-version shared-checksum retention, successful in-org normal-user cookbook read/delete coverage, usable signed recipe download coverage, and cookbook-route auth 401/403 coverage
