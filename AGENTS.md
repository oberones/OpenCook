...
The next likely major slice is remaining core Chef object compatibility hardening, with deployment-test-discovered or live-source-discovered Chef compatibility gaps taking priority if they prove higher risk.
