...
- the first cookbook compatibility slice:
  ...
  - multi-version shared-checksum retention, successful in-org normal-user cookbook read/delete/create/update coverage, usable signed recipe download coverage, create/update no-mutation coverage for failed outside-user and invalid-user mutations, and cookbook-route auth 401/403 coverage
