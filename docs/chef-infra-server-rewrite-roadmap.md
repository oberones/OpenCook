...
- role environment endpoints are implemented via `/roles/{name}/environments` and `/roles/{name}/environments/{environment}`, including linked-missing-environment list-vs-read parity
