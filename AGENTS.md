...
- the first cookbook compatibility slice:
  ...
  - broader create/update HTTP coverage for metadata-name write-vs-read canonicalization, permissive `metadata.providing`, and exact no-mutation behavior for invalid metadata payloads
