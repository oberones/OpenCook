...
func NewRouter(deps Dependencies) http.Handler {
	...
	mux.HandleFunc("/internal/admin/server-admins", srv.withAuthn("internal-admin-server-admins", srv.handleInternalServerAdmins))
	...
	mux.HandleFunc("/internal/maintenance/repair/org-membership", srv.withAuthn("maintenance-repair-org-membership", srv.handleMaintenanceRepairOrgMembership))
	mux.HandleFunc("/internal/maintenance/repair/group-membership", srv.withAuthn("maintenance-repair-group-membership", srv.handleMaintenanceRepairGroupMembership))
	mux.HandleFunc("/internal/maintenance/repair/server-admins", srv.withAuthn("maintenance-repair-server-admins", srv.handleMaintenanceRepairServerAdmins))
