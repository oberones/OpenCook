...
| Keys and API versions | `API_VERSIONING.md`, pedant versioned behaviors | Partial | `internal/authn`, `internal/api` | In progress | Actor `/keys` list/create/delete flows and expiration-aware auth are live; PUT and deeper v0/v1 semantics still need a dedicated pass |
