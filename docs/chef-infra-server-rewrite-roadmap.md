...
As of 2026-04-24, OpenCook has moved past pure scaffolding and into the first compatibility slices:
...
- persist the remaining core object APIs on top of the PostgreSQL bootstrap foundation
